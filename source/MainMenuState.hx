...
//		char1.visible = false;
		...
		var versionShit:FlxText = new FlxText(12, ClientPrefs.getResolution()[1] - 44, 0, "E_P_L_ Engine ver 0.0.1 Psych Engine v" + psychEngineVersion, 12);
...
//		}
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				if (optionShit[curSelected] == 'fardsoundeffect')
					{
