...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Damn Your Trash', 0.2], //From 0% to 19%
		...
		['SUPERMAN', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("time.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("font.otf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scoreTxt.scrollFactor.set();
		scoreTxt.borderSize = 1.25;
		scoreTxt.visible = !ClientPrefs.hideHud;
		add(scoreTxt);

		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "GAYMODE", 32);
		botplayTxt.setFormat(Paths.font("font.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
  ...
  public function clearShaderFromCamera(cam:String){
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'JumpScare':
				//if(!ClientPrefs.jumpScares) {
				var bruh:FlxSprite = new FlxSprite();
				bruh.loadGraphic(Paths.image(value1));
				bruh.antialiasing = true;
				bruh.active = false;
				bruh.scrollFactor.set();
				bruh.screenCenter();
				FlxG.sound.play(Paths.sound(value2));
				add(bruh);
			...
			case 'FlashChange character':
					//THis will flash then change the caracter
				var bruh:FlxSprite = new FlxSprite();
				bruh.loadGraphic(Paths.image('Whitescreen'));//if you fell like it make a option that is dark mode
				bruh.antialiasing = true;
				bruh.active = false;
				bruh.scrollFactor.set();
				bruh.screenCenter();
