...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['JumpScare', "Value1 is the image\nValue2 is the sound"],
		['FlashChange character', "Value 1: Character to change (Dad, BF, GF)\nValue 2: New character's name\nthis is not night-friendly\ndont place this in any hard part of any song"],
